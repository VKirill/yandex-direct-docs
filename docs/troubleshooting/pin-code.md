...
При звонке в [отдел клиентского сервиса Яндекс Директа](ru/contact-us) специалисты запрашивают номер кампании и разовый PIN-код. Он действует в течение 15 минут и требуется для каждого нового обращения по телефону. Это нужно для безопасности данных: только вы можете выдать доступ специалисту к вашим кампаниям и только на время звонка.
