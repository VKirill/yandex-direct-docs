...
- [Не знаю, сколько платить за клик](ru/troubleshooting/bidding#not-sure)
- [Что значит объем трафика?](ru/troubleshooting/bidding#traffic-volume)
- [Почему объем трафика может быть больше 100?](ru/troubleshooting/bidding#traffic-volume-100)
- [Прогнозируемая ставка слишком высока](ru/troubleshooting/bidding#price-too-big)
- [Что такое списываемая цена?](ru/troubleshooting/bidding#click-price)
- [Что такое минимальная цена на поиске?](ru/troubleshooting/bidding#min-cpc)
- [Не могу набрать статистику показов, чтобы увеличить CTR объявления](ru/troubleshooting/bidding#statistics-myth)
- [У аккаунта высокий показатель качества, но ставки не снижаются](ru/troubleshooting/bidding#account-quality)
- [После изменения ставок списываются старые цены](ru/troubleshooting/bidding#bids-activation)
- [Списывается цена, превышающая ставку](ru/troubleshooting/bidding#more-than-bid)
...
[Вопросы по интерфейсу Директа](ru/troubleshooting/interface)
