---
source: https://yandex.ru/support/direct/ru/troubleshooting/error-ban
---

Тематику объявления ошибочно отнесли к запрещенной

# Тематику объявления ошибочно отнесли к запрещенной

Если объявление было отклонено на модерации, но вы не продвигаете [запрещенные товары и услуги](ru/moderation/restricted-categories), напишите нам через форму ниже, в чат или сообщите по телефону.
