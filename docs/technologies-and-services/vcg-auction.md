...
- [Отбор и ранжирование объявлений](ru/technologies-and-services/vcg-auction#adv-choose)
- [Определение списываемой цены](ru/technologies-and-services/vcg-auction#calculate-price)
  - [VCG-аукцион](ru/technologies-and-services/vcg-auction#calc-vcg)
  - [VCG-аукцион для расширенного формата](ru/technologies-and-services/vcg-auction#vcg-traf)
  - [GSP-аукцион](ru/technologies-and-services/vcg-auction#calc-gsp)
...
- на поиске Яндекса и на поисковых площадках РСЯ списываемая цена определяется по правилам [VCG-аукциона](ru/technologies-and-services/vcg-auction#calc-vcg);
- на тематических площадках РСЯ и во внешних сетях списываемая цена определяется по правилам [GSP-аукциона](ru/technologies-and-services/vcg-auction#calc-gsp).
