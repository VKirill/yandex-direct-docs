...
- [Цели и сегменты Метрики](ru/technologies-and-services/metrika-in-direct#data)
- [Что можно настроить с помощью Метрики](ru/technologies-and-services/metrika-in-direct#purposes)
