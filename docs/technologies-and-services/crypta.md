...
- [Как работает](ru/technologies-and-services/crypta#how-it-works)
- [Как определяет пользователя на разных устройствах](ru/technologies-and-services/crypta#matching)
- [Домохозяйство пользователя](ru/technologies-and-services/crypta#household)
- [Как используется в продвижении и рекламе](ru/technologies-and-services/crypta#where-it-works)
...
Данные Крипты о пользователях учитываются при отборе объявлений Директа, которые показываются на сайтах Рекламной сети Яндекса. Благодаря Крипте возможно нацеливание [медийной рекламы](ru/products-cpm-campaign/about) на пользователей с определенными характеристиками (семейным положением, профессиями, интересами, привычками), а также нацеливание [текстово-графических объявлений](ru/unified-performance-campaign/create-text-image) в Единой перфоманс-кампании по краткосрочным интересам. Например, если пользователь искал в интернете молочные смеси и заказывал такси с детским креслом, можно считать, что у него есть маленький ребенок; если посещал ресурсы про рекламу или разработку, то пользователь — маркетолог или программист. Данные Крипты также используются для [корректировок ставок](ru/impressions/bids-adjustment) по полу и возрасту.
