...
Показы объявлений с трагическим контентом возможны только на поиске, на некоторых площадках в сетях и в Картах по прямому запросу. В [телеграм-каналах](ru/efficiency/telegram-ads) показов не будет.

Объявления данной тематики размещаются только в форматах [текстово-графических](ru/unified-performance-campaign/create-text-image), [товарных](ru/unified-performance-campaign/create-product) объявлений и объявлений для [страниц каталога](ru/unified-performance-campaign/create-catalogs) в Единой перфоманс-кампании.
