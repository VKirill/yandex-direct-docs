...
Если вы продвигаете товары и услуги нескольких категорий (например, лекарства и БАД), документы должны быть для каждой из них.
