...
- если это валюта, необходимо предоставить документы для продвижения [услуг на рынке Форекс](ru/moderation/categories/finance-forex);
- в других случаях необходимые документы аналогичны описанным в разделе о продвижении [бинарных опционов](ru/moderation/categories/finance-binary-options).
...
- если это валюта, должны быть документы для продвижения [услуг на рынке Форекс](ru/moderation/categories/finance-forex);
- в других случаях необходимые документы аналогичны описанным в разделе о продвижении [бинарных опционов](ru/moderation/categories/finance-binary-options).
...
- если это валюта, необходимо должны быть документы для продвижения [услуг на рынке Форекс](ru/moderation/categories/finance-forex);
- в других случаях необходимые документы аналогичны описанным в разделе о продвижении [бинарных опционов](ru/moderation/categories/finance-binary-options).
