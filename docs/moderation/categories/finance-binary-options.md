...
Для показа объявлений должен быть один из следующих документов, выданных в РБ:
...
Для показа объявлений должен быть один из следующих документов, выданных в РК:
