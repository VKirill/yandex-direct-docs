...
- Если указано, что продвигаемое средство можно использовать в косметологии, для размещения потребуются документы, перечисленные в разделе [Аптеки и лекарства](ru/moderation/categories/medicine-pharmacies).
...
- Если указано, что продвигаемое средство можно использовать в косметологии, для размещения должны быть документы, перечисленные в разделе [Аптеки и лекарства](ru/moderation/categories/medicine-pharmacies#by).
- Если продвигаются ингредиенты для косметологии, для размещения должен быть либо сертификат или декларация соответствия на ингредиенты, либо свидетельство о государственной регистрации.
- Если указано, что в состав средства входит гиалуроновая кислота, для размещения должна быть декларация соответствия на продвигаемое средство, в которой есть подтверждение наличия гиалуроновой кислоты.
...
- Если указано, что продвигаемое средство можно использовать в косметологии, для размещения потребуется предоставить документы, перечисленные в разделе [Аптеки и лекарства](ru/moderation/categories/medicine-pharmacies#kz).
- Если продвигаются ингредиенты для косметологии, для размещения должен быть либо сертификат или декларация соответствия на ингредиенты, либо свидетельство о государственной регистрации.
- Если указано, что в состав средства входит гиалуроновая кислота, для размещения должна быть декларация соответствия на продвигаемое средство, в которой есть подтверждение наличия гиалуроновой кислоты.
