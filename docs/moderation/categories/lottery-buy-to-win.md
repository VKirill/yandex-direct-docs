...
Если стимулирующее мероприятие позиционируется как лотерея, проверка проходит по правилам раздела [Лотереи](ru/moderation/categories/lottery-lotteries#ru).
...
Для продвижения стимулирующих мероприятий необходимы документы, перечисленные в разделе [Лотереи](ru/moderation/categories/lottery-lotteries#by).
