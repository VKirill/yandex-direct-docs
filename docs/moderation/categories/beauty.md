...
Будьте внимательны при составлении своих объявлений: если вы явно указываете лечебный эффект или упоминаете название заболевания, то модерация объявлений будет проходить по правилам, описанным в разделе [Медицинские услуги](ru/moderation/categories/medicine-medical-activity).

Яндекс не показывает [объявления на деликатные темы](ru/moderation/categories/considerate), как по поведенческому таргетингу, так и по условиям ретаргетинга и подбора аудитории (даже если ваше объявление прошло модерацию и условия показов настроены корректно).
