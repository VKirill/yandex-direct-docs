...
- [Какие показатели отслеживать](ru/products-cpm-campaign-frontpage/statistics#parameters)
- [Как сформировать отчет](ru/products-cpm-campaign-frontpage/statistics#report-wizard)
- [Как принимать решения на основе статистики](ru/products-cpm-campaign-frontpage/statistics#conclusion)
...
Если кампания выигрывает слишком мало аукционов за показ рекламы, рекомендуем увеличить ставку за 1000 показов (в случае ручной стратегии) или повысить ограничение средней цены за 1000 показов (в случае автоматической стратегии). Сверьтесь с [таблицей](ru/products-cpm-campaign-frontpage/min-bid), корректно ли установлена ставка или средняя цена для разных регионов показа.
...
[Ретаргетинг на аудиторию медийной кампании](ru/products-cpm-campaign-frontpage/retargeting)
