...
- [Какие показатели отслеживать](ru/fixed-cpm-campaigns/branding-cover/statistics#parameters)
- [Как сформировать отчет](ru/fixed-cpm-campaigns/branding-cover/statistics#report-wizard)
- [Как принимать решения на основе статистики](ru/fixed-cpm-campaigns/branding-cover/statistics#conclusion)
