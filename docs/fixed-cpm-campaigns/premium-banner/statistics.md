...
- [Какие показатели отслеживать](ru/fixed-cpm-campaigns/premium-banner/statistics#parameters)
- [Как сформировать отчет](ru/fixed-cpm-campaigns/premium-banner/statistics#report-wizard)
- [Как принимать решения на основе статистики](ru/fixed-cpm-campaigns/premium-banner/statistics#conclusion)
