...
- [Расположение текста и элементов баннера](ru/fixed-cpm-campaigns/premium-banner/big-banner#placement)
- [Шрифт](ru/fixed-cpm-campaigns/premium-banner/big-banner#font)
- [Изображение](ru/fixed-cpm-campaigns/premium-banner/big-banner#image)
- [Элементы креатива](ru/fixed-cpm-campaigns/premium-banner/big-banner#elements)
- [Рекомендованные цвета](ru/fixed-cpm-campaigns/premium-banner/big-banner#colors)
- [Оформление предупреждений и обязательной юридической информации](ru/fixed-cpm-campaigns/premium-banner/big-banner#main-info)
