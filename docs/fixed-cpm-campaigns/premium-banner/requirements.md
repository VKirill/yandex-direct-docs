...
- [Технические требования к графическому баннеру](ru/fixed-cpm-campaigns/premium-banner/requirements#technical-image)
- [Технические требования к HTML5-баннеру](ru/fixed-cpm-campaigns/premium-banner/requirements#technical)
- [Требования модерации](ru/fixed-cpm-campaigns/premium-banner/requirements#moderation)
...
11. В баннере не должны использоваться инструменты сбора статистики (пиксели, счетчики и прочие).
    ...
    При создании кампании вы сможете указать пиксель Яндекс Аудиторий или счетчик ADFOX (подробнее в разделе [Как запустить кампанию](ru/fixed-cpm-campaigns/premium-banner/create)), а также использовать [UTM-метки](ru/statistics/url-tags) в ссылке на сайт.
...
[Как запустить кампанию](ru/fixed-cpm-campaigns/premium-banner/create)

Следующая

[Рекомендации по оформлению](ru/fixed-cpm-campaigns/premium-banner/big-banner)
