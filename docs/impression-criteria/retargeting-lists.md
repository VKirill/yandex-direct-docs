...
- [Как работает](ru/impression-criteria/retargeting-lists#how-it-works)
- [Условия формирования сегментов аудитории](ru/impression-criteria/retargeting-lists#zoo)
- [Как создать сегмент аудитории](ru/impression-criteria/retargeting-lists#how-to)
- [Советы по настройке](ru/impression-criteria/retargeting-lists#tips)
- [Назначение ставок](ru/impression-criteria/retargeting-lists#bids)
...
- **Отказы** — пользователи, которые открыли одну страницу сайта, провели на ней меньше 15 секунд и не совершили ни одного целевого действия. По умолчанию в этот сегмент попадают визиты за последние 540 дней. Если требуется ограничить период, можно указать период при [настройке условий](ru/impression-criteria/retargeting-lists#how-to) формирования сегмента аудитории.
