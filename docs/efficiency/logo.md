...
Логотип можно добавлять в [видеообъявления](ru/products-cpm-campaign-video/about) медийных кампаний. Он повысит заметность бренда ещё до начала просмотра ролика.
...
Загрузите картинку с компьютера или выберите из ранее добавленных в Директ. Изображение на логотипе должно соответствовать [требованиям](ru/moderation/ad-rules#pics). Проверьте, как логотип отображается в объявлении. Если он не считывается, лучше заменить картинку.

Статистика показов объявлений с дополнительным оформлением доступна в [Мастере отчетов](ru/statistics/report-wizard). Чтобы проанализировать количество кликов по логотипу, тексту, выберите срез **Место клика** → **Заголовок**.
