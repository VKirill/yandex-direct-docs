...
- уточнить [ключевые фразы](ru/keywords/building-keyword-list) и добавить новые;
- проработать [элементы объявления](ru/efficiency/improve-your-ads);
- изменить [ставки по ключевым фразам](ru/strategies/manual-strategy#how-to-bid);
- указать [регионы](ru/efficiency/geotargeting), в которых показывается объявление;
- настроить [корректировку ставок по времени](ru/efficiency/timetargeting#hourly-adjustment);
- создать [отдельную кампанию для показов в сетях](ru/efficiency/content-websites);
- провести [эксперименты с объявлениями](ru/efficiency/ad-groups).

Проанализируйте [статистику](ru/statistics/performance-stat-guide) по своей рекламной кампании, чтобы увидеть ее сильные и слабые стороны и выбрать наилучший способ увеличения эффективности.

Обратите внимание на качество вашего сайта. Выяснить причины ухода посетителей и понять, как улучшить результат, можно при помощи [Яндекс Метрики](ru/statistics/metrika).
