...
Статистика показов объявлений с дополнительным оформлением доступна в [Мастере отчетов](ru/statistics/report-wizard). Чтобы проанализировать количество кликов по кнопке, выберите срез **Место клика** → **Кнопка**.
