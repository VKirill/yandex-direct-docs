...
- [товарных](ru/unified-performance-campaign/create-product) объявлений и объявлений для [страниц каталога](ru/unified-performance-campaign/create-catalogs) в Единой перфоманс-кампании;
- [товарных кампаний](ru/campaign-master/product-campaign).
...
- [Типы фидов](ru/feeds/types) — выбрать тип фида.
- [Требования к фиду](ru/feeds/requirements) — как заполнять файл фида.
- [Добавление фида](ru/feeds/add) — как добавить фид в Директ с помощью файла или ссылки.
- [Валидация файла](ru/feeds/validate) — какие условия проверяются при чтении файла.
