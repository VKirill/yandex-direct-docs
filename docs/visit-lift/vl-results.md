...
- [Если результаты положительные](ru/visit-lift/vl-results#positive)
- [Если значимого прироста нет](ru/visit-lift/vl-results#negative)
...
[Как запустить](ru/visit-lift/vl-enable)
