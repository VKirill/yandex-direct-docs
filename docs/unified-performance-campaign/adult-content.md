...
Площадки с контентом для взрослых представлены сервисами [Яндекс Картинки](http://images.yandex.ru/) и [Яндекс Видео](http://video.yandex.ru/). Если вы решили показывать на них объявления, проверьте, что они не добавлены в список площадок для [запрета показов](ru/campaigns/blocked-sites) в настройках кампании.
