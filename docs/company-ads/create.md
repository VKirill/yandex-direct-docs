...
Настройте продвижение в [Картах](ru/company-ads/maps) и в [списке организаций в результатах поиска](ru/company-ads/company-card). Такое продвижение поднимет карточку организации выше в результатах поиска и сделает объявление более заметным и информативным.

- [Настроить с Простым стартом](ru/company-ads/create-pa)
- [Настроить в Мастере кампаний](ru/company-ads/create-cm)
- [Настроить в Единой перфоманс-кампании](ru/company-ads/create-upc)
